...
(function ($) {
    ...
    $.fn.extend({
                    ...
                    if (this.isFormValid() === true) {
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (result) {
                                layer.close();
                                result.code === 1 ? $.show_success(result.msg, result.url,result.data)
         ...
         * 删除元素
         */
        delete: function (index, url,tip_msg) {
            tip_msg?tip_msg:"确认删除该项吗？";
            $(this).click(function () {
                var param = {};
        ...
        selectImages: function (option) {
            ...
            var $this = this
                ...
                , defaults = {
                    ...
                    , imagesTemplate: 'tpl-file-item'    // 图片列表容器
            ...
            $this.fileLibrary({
                type: 'image'
                ,multiple:options.multiple ? 1 : 2 //1多选框  2单选弹框
                , done: function (data, $touch) {
                    ...
                    // 新增图片列表
                    var $html = $(template(options.imagesTemplate, {list: list, name: options.name}))
                        ...
                        $form.ajaxSubmit({
                            ...
                            success: function (result) {
                                ...
                                setTimeout(function() {
                                    ...
                                    parent.layer.close(varindex);// 关闭layer
                                },500);
                                btn_submit.attr('disabled', false);
    ...
    $.extend({
         ...
         * @param msg
         * @param url
         * @param data  1  关闭弹窗 否则不处理
         */
        show_success: function (msg, url,data) {
            layer.msg(msg, {
                icon: 1
                , time: 1800
                // , anim: 1
        ...
        uploadImage: function (option) {
            // 文件大小
            var maxSize = option.maxSize !== undefined ? option.maxSize : 10000000
                // 初始化Web Uploader
...
$(function () {
    ...
    // 删除图片 (数据库已有的)
    $(document).on("click",".file-item-delete",function (){
        var _this = this;
