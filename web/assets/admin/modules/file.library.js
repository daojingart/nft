    ...
    FileLibrary.prototype = {
        ...
        uploadImagesEvent: function () {
            ...
            var uploader = WebUploader.create({
                ...
                auto: true,
                // 文件接收服务端。
                server: STORE_URL + '/upload.upload/image',
                // 选择文件的按钮。可选。
                ...
                accept: {
                    title: 'Images',
                    extensions: 'gif,jpg,jpeg,bmp,png,glb',
                    mimeTypes: 'file/*'
                },
                // 文件上传header扩展
                headers: {
        ...
        /**
         * 注册选中事件增加判断是否是单选还是多选判断
         * @Time 2021年03月27日22:59:16
         * @author ****@163.com
         * @copyright ..
         */
        selectFilesEvent: function () {
            ...
            if(this.options.multiple === 2){
                this.$element.find('#file-list-body').on('click', '.file-list-item li', function () {
                    $(".file-list-item li").removeClass('active');
