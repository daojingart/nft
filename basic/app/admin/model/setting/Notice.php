...
class Notice extends NoticeModel
{
    ...
    public function getDataList($param)
    {
        ...
        foreach ($dataList as $k=>$v){
            $categoryInfo = (new ProductCategory())->where(['category_id'=>$v['category_id']])->find();
            $dataList[$k]['category_name'] = $categoryInfo['name'];
    ...
    private static  function makeButton($id)
    {
        return [
            '编辑' => [
                'href' => url('application.notice/renew', ['id' => $id]),
                'lay-event' => '',
            ],
            '删除' => [
    ...
    {
        return $this->save(['disabled' => self::$disabled],['id'=>$this['id']]);
    }
}