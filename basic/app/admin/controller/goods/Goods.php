...
use app\admin\model\product\ProductCategoryGoods;
...
class Goods extends Controller
{
    ...
    {
        if (request()->isAjax()){
            return  (new ProductModel())->getList(20);
        }
        return $this->fetch();
    }
    ...
    public function add()
    {
        ...
        // 配送模板
        $delivery = \app\admin\model\product\Delivery::getAll();
        $list = (new ProductCategoryGoods())->select();
        return $this->fetch('',compact('list','delivery'));
    }
