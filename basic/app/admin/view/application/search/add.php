                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="search[title]"
                                           value="" placeholder="搜索标题" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">所属类型 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="search[type]" required data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择所属类型',maxHeight:'200px'}">
