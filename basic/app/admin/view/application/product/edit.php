                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="product[sales_actual]" placeholder="请输入实际销量" class="layui-input" value="{{$data.sales_actual?:''}}">
                                </div>
                            </div>
                            <div class="widget-head am-cf">
                        ...
                        <div class="am-form-group layui-form">
                            ...
                            <div class="am-u-sm-9 am-u-end">
                                <input type="radio" name="product[hold_goods_status]" value="10" title="关闭" lay-filter="label_type" {{if $data.hold_goods_status==10}}checked{{/if}} >
                                <input type="radio" name="product[hold_goods_status]" value="20" title="开启" lay-filter="label_type" {{if $data.hold_goods_status==20}}checked{{/if}}>
                            </div>
                        </div>
                        <div class="am-form-group layui-form hold_goods_list" style="display: <?= $data['hold_goods_status'] == 20 ? 'block' : 'none' ?>;">
                            <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">门槛藏品</label>
                            <div class="am-u-sm-9 am-u-end" id="course_info">
                                <input type="hidden" id="goods_id" class="layui-input layui-disabled" name="product[hold_goods_id]"  value="{{$data.hold_goods_id}}">
                                <div id="goods_show" class="chose-class-wrap"><div class="assort-class-wrap">
                                        <img src="{{$data.goods_info.goods_thumb}}" id="goods_thumb" class="assort-class-img">
                                        <div class="class-title-wrap">
                                            <p class="class-title" id="goods_name" >{{$data.goods_info.goods_name}}</p>
                                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9 am-u-end">
                                <input type="number" name="product[limit_buy_number]" placeholder="请输入兑换的数量" class="layui-input" value="{{$data.limit_buy_number}}">
