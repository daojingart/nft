                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="type" value="1" title="红包"  lay-filter="goods_type" {{if $data.type==1}} checked {{/if}}>
                                    <input type="radio" name="type" value="2" title="藏品"  lay-filter="goods_type" {{if $data.type==2}} checked {{/if}}>
                                    <input type="radio" name="type" value="3" title="产品"  lay-filter="goods_type" {{if $data.type==3}} checked {{/if}}>
                                    <input type="radio" name="type" value="4" title="空奖"  lay-filter="goods_type" {{if $data.type==4}} checked {{/if}}>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="name" value="{{$data.name??''}}" placeholder="请输入奖品名称"  required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="level" value="0" title="普通"   {{if $data.level==0}} checked {{/if}}>
                                    <input type="radio" name="level" value="1" title="一等奖"  {{if $data.level==1}} checked {{/if}}>
                                    <input type="radio" name="level" value="2" title="二等奖"   {{if $data.level==2}} checked {{/if}}>
                                    <input type="radio" name="level" value="3" title="三等奖"  {{if $data.level==3}} checked {{/if}}>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="probability" value="{{$data.probability??''}}" placeholder="请输入中奖权重" required>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="stock" value="{{$data.stock??''}}" placeholder="请输入奖品库存" required>
                                </div>
                            </div>
