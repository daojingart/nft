    ...
    <div class="layui-card-body">
        ...
        <div class="layui-row layui-col-space12">
            <div class="layui-col-md3">
                <a class="layui-btn layui-btn-normal" href="<?= url('application.synthetic/add') ?>">添加合成</a>
            </div>
        </div>
...
<script>
    layui.use(['table', 'form', 'jquery','toast','dropdown','laydate'], function() {
        ...
        let tableIns = table.render({
            elem: '#user-table',
            id:'videoID',
            url: "{{:url('application.synthetic/index')}}",
            page: true,
            cols: cols,
            skin: 'line',
        ...
        window.remove = function(obj) {
            layer.confirm('确认删除吗？', {
                ...
                $.getJSON("{{:url('common/del')}}", {'id' : obj.data['id'],'dbname':'GoodsSynthetic'}, function(result){
                    layer.close(loading);
                    if(1 === result.code){
