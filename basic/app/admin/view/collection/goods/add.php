                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[buy_num]" value="" placeholder="请输入限购数量" required>
                                    <small>0是不限制</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[stock_num]" value="" placeholder="请输入发行库存" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" id="start_time" name="goods[start_time]" placeholder="请输入开售时间" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="goods[is_limit_number]" value="10" title="关闭" checked>
                                    <input type="radio" name="goods[is_limit_number]" value="20" title="开启" >
                            ...
                            <div class="am-form-group consignment-paid-trainee">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">设置转增时间</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="goods[consignment_minute]" placeholder="请输入转增时间(分钟)" class="layui-input" value="">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
