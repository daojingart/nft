...
<script type="text/html" id="w_status">
    <div class="am-text-middle" rowspan="1">
        {{#  if(d.sale_status == 10){ }}
        <input lay-filter="putShelf" type="checkbox" value="10" title="已显示" checked data-goods-id="{{d.goods_id}}">
        {{#  } else { }}
        <input lay-filter="putShelf" type="checkbox" value="20"  title="已隐藏" data-goods-id="{{d.goods_id}}">
        {{#  } }}
    </div>
</script>
<!-- 审核状态  -->
