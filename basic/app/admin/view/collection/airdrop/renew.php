        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <input type="hidden" name="airdrop[product_types]" value="2">
                    <input type="hidden" name="airdrop[goods_id]" value="{{$model.goods_id}}">
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="airdrop[goods_name]" value="<?= $model['goods_name'] ?>" placeholder="请输入作品名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if (isset($model['goods_thumb'])):?>
                                                <div class="file-item">
                                                    ...
                                                    <input type="hidden" name="airdrop[goods_thumb]" value="<?= $model['goods_thumb'] ?>">
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_suffix]" value="10" title="gif动态图片" {{if $model.is_suffix == 10}} checked {{/if}}>
                                    <input type="radio" name="airdrop[is_suffix]" value="20" title="GLB3D展示"  {{if $model.is_suffix == 20}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <?php if (isset($model['d_images'])):?>
                                                    <div class="file-item">
                                                        ...
                                                        <input type="hidden" name="airdrop[d_images]" value="<?= $model['d_images'] ?>">
                                                        <i class="iconfont icon-shanchu file-item-delete"></i>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="airdrop[writer_id]" required data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择所属作者',maxHeight:'200px'}">
                                        <option value=""></option>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="airdrop[category_id]" required data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择所属分组',maxHeight:'200px'}">
                                        <option value=""></option>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[goods_type]" value="1" title="视频"  lay-filter="goods_type"	{{if $model.goods_type == 1}} checked {{/if}}>
                                    <input type="radio" name="airdrop[goods_type]" value="3" title="图片"  lay-filter="goods_type" {{if $model.goods_type == 3}} checked {{/if}}>
                                </div>
                            </div>
                            <!-- 视频 -->
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <input type="text" class="tpl-form-input video_link_url" name="airdrop[video_link_url]" value="{{$model.video_link_url}}" required>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <input type="text" class="tpl-form-input audio_link_url" name="airdrop[audio_link_url]" value="{{$model.audio_link_url}}" required>
                                                <input type="file" style="display:none;" ref="vExampleFile" @change="vExampleUpload" />
                                            </div>
                                        </div>
                                        <div class="note_controller" style="display: none;margin-top: 10px;" >
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" maxlength="6" class="tpl-form-input" name="airdrop[goods_no]" value="<?= $model['goods_no'] ?>" placeholder="请输入作品编码" required>
                                    <small>作品唯一性</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[buy_num]" value="<?= $model['buy_num'] ?>" placeholder="请输入限购数量" required>
                                    <small>0是不限制</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[stock_num]" value="<?= $model['stock_num'] ?>" placeholder="请输入发行数量" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[original_number]" <?= $model['original_number']?'disabled':'' ?> value="<?= $model['original_number'] ?>" placeholder="请输入发行数量" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" id="start_time" name="airdrop[start_time]" placeholder="请输入开售时间" class="layui-input" value="<?= $model['start_time'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">作品售价 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[goods_price]" placeholder="请输入作品售价" class="layui-input" value="<?= $model['goods_price'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[recovery_status]" value="0" title="否" {{if $model.recovery_status == 0}} checked {{/if}}>
                                    <input type="radio" name="airdrop[recovery_status]" value="1" title="是" {{if $model.recovery_status == 1}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">回收数量 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[recovery_num]" placeholder="请输入回收数量" class="layui-input" value="<?= $model['recovery_num'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">回收价格 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[recovery_price]" placeholder="请输入回收价格" class="layui-input" value="<?= $model['recovery_price'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" name="airdrop[issue_name]" placeholder="请输入发行方" class="layui-input" value="<?= $model['issue_name'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">发行标签 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" name="airdrop[issue_tag]" placeholder="请输入发行标签" class="layui-input" value="<?= $model['issue_tag'] ?>">
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_open_increase]" value="10" title="系统配置" lay-filter="is_open_increase" {{if $model.is_open_increase == 10}} checked {{/if}}>
                                    <input type="radio" name="airdrop[is_open_increase]" value="20" title="单独设置" lay-filter="is_open_increase" {{if $model.is_open_increase == 20}} checked {{/if}}>
                                    <input type="radio" name="airdrop[is_open_increase]" value="30" title="关闭转增" lay-filter="is_open_increase" {{if $model.is_open_increase == 30}} checked {{/if}}>
                            ...
                            <div class="am-form-group individually-paid-trainee" style="display: <?= $model['is_open_increase'] == 20 ? 'block' : 'none' ?>;">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[increas_minute]" placeholder="请输入转增时间(分钟)" class="layui-input" value="{{$model.increas_minute}}">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_open_consignment]" value="10" title="系统配置" lay-filter="is_open_consignment" {{if $model.is_open_consignment == 10}} checked {{/if}}>
                                    <input type="radio" name="airdrop[is_open_consignment]" value="20" title="单独设置" lay-filter="is_open_consignment" {{if $model.is_open_consignment == 20}} checked {{/if}}>
                                    <input type="radio" name="airdrop[is_open_consignment]" value="30" title="关闭寄售" lay-filter="is_open_consignment" {{if $model.is_open_consignment == 30}} checked {{/if}}>
                            ...
                            <div class="am-form-group consignment-paid-trainee"  style="display: <?= $model['is_open_consignment'] == 20 ? 'block' : 'none' ?>;">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">设置转增时间</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[consignment_minute]" placeholder="请输入寄售时间(分钟)" class="layui-input" value="{{$model.consignment_minute}}">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[limit_consignment_open]" value="10" title="系统配置" lay-filter="limit_consignment_open" {{if $model.limit_consignment_open == 10}} checked {{/if}}>
                                    <input type="radio" name="airdrop[limit_consignment_open]" value="20" title="单独设置" lay-filter="limit_consignment_open" {{if $model.limit_consignment_open == 20}} checked {{/if}}>
                            ...
                            <div class="am-form-group limit_consignment_open_content" style="display: <?= $model['limit_consignment_open'] == 20 ? 'block' : 'none' ?>;">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[top_price_limit]" placeholder="请输入固定的限制最高价格" class="layui-input" value="{{$model.top_price_limit}}">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">最低价</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[minimum_consignment]" placeholder="请输入固定的最低限制价格" class="layui-input" value="{{$model.minimum_consignment}}">
                                    </div>
                                </div>
                            </div>
                            <!-- 限制价格 -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <textarea id="container" name="airdrop[content]" type="text/plain"><?= $model['content'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[goods_sort]" placeholder="请输入排序值" class="layui-input" value="<?= $model['goods_sort'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">已售 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[sales_initial]" placeholder="请输入已售" class="layui-input" value="<?= $model['sales_initial'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">状态 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[goods_status]" value="10" title="显示" {{if $model.goods_status.value == 10}} checked {{/if}}>
                                    <input type="radio" name="airdrop[goods_status]" value="20" title="隐藏" {{if $model.goods_status.value == 20}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
...
<script>
    ...
    $(function () {
        ...
        $('.upload-file').selectImages({
            name: 'airdrop[goods_thumb]',
        });

        // 选择图片
        $('.upload-file1').selectImages({
            name: 'airdrop[d_images]',
        });
