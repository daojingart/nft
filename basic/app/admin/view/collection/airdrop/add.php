                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="airdrop[goods_name]" value="" placeholder="请输入作品名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_suffix]" value="10" title="gif动态图片" checked>
                                    <input type="radio" name="airdrop[is_suffix]" value="20" title="GLB3D展示" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        ...
                                        <div class="help-block am-margin-top-sm">
                                            <small>尺寸900x900像素以上，大小2M以下</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[goods_type]" value="1" title="视频"  lay-filter="goods_type"	 checked>
                                    <input type="radio" name="airdrop[goods_type]" value="3" title="图片"  lay-filter="goods_type">
                                </div>
                            </div>
                            <!-- 视频 -->
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <input type="text" class="tpl-form-input video_link_url" name="airdrop[video_link_url]" value="" required>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                <input type="text" class="tpl-form-input audio_link_url" name="airdrop[audio_link_url]" value="" required>
                                                <input type="file" style="display:none;" ref="vExampleFile" @change="vExampleUpload" />
                                            </div>
                                        </div>
                                        <div class="note_controller" style="display: none;margin-top: 10px;" >
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" maxlength="6" class="tpl-form-input" name="airdrop[goods_no]" value="" placeholder="请输入作品编码" required>
                                    <small>作品唯一性</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[buy_num]" value="" placeholder="请输入限购数量" required>
                                    <small>0是不限制</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[stock_num]" value="" placeholder="请输入发行库存" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="airdrop[original_number]" value="" placeholder="请输入发行数量" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" id="start_time" name="airdrop[start_time]" placeholder="请输入开售时间" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">作品售价 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[goods_price]" placeholder="请输入作品售价" class="layui-input" value="">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[recovery_status]" value="0" title="否" checked>
                                    <input type="radio" name="airdrop[recovery_status]" value="1" title="是">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">回收数量 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[recovery_num]" placeholder="请输入回收数量" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">回收价格 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[recovery_price]" placeholder="请输入回收价格" class="layui-input" value="">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" name="airdrop[issue_name]" placeholder="请输入发行方" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">发行标签 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" name="airdrop[issue_tag]" placeholder="请输入发行标签" class="layui-input" value="">
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_open_increase]" value="10" title="系统配置" lay-filter="is_open_increase" checked>
                                    <input type="radio" name="airdrop[is_open_increase]" value="20" title="单独设置" lay-filter="is_open_increase">
                                    <input type="radio" name="airdrop[is_open_increase]" value="30" title="关闭转增" lay-filter="is_open_increase">
                            ...
                            <div class="am-form-group individually-paid-trainee">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[increas_minute]" placeholder="请输入转增时间(分钟)" class="layui-input" value="">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[is_open_consignment]" value="10" title="系统配置" lay-filter="is_open_consignment" checked>
                                    <input type="radio" name="airdrop[is_open_consignment]" value="20" title="单独设置" lay-filter="is_open_consignment">
                                    <input type="radio" name="airdrop[is_open_consignment]" value="30" title="关闭寄售" lay-filter="is_open_consignment">
                            ...
                            <div class="am-form-group consignment-paid-trainee">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">设置转增时间</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[consignment_minute]" placeholder="请输入寄售时间(分钟)" class="layui-input" value="">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[limit_consignment_open]" value="10" title="系统配置" lay-filter="limit_consignment_open" checked>
                                    <input type="radio" name="airdrop[limit_consignment_open]" value="20" title="单独设置" lay-filter="limit_consignment_open">
                            ...
                            <div class="am-form-group limit_consignment_open_content">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[top_price_limit]" placeholder="请输入固定的限制最高价格" class="layui-input" value="">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">最低价</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="airdrop[minimum_consignment]" placeholder="请输入固定的最低限制价格" class="layui-input" value="">
                                    </div>
                                </div>
                            </div>
                            <!-- 限制价格 -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <textarea id="container" name="airdrop[content]" type="text/plain"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[goods_sort]" placeholder="请输入排序值" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">已售 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="airdrop[sales_initial]" placeholder="请输入已售" class="layui-input" value="">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">状态 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="airdrop[goods_status]" value="10" title="显示" checked>
                                    <input type="radio" name="airdrop[goods_status]" value="20" title="隐藏">
                                </div>
                            </div>
                            <div class="am-form-group">
