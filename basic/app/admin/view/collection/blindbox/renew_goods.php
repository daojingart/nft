                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="goods[probability]" placeholder="请输入1-100 的概率" class="layui-input" value="<?= $model['probability'] ?>">
                                </div>
                            </div>
                            {{/if}}
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="goods[stock_num]" placeholder="请输入库存数量" class="layui-input" value="<?= $model['stock_num'] ?>">
                                    <small>请合理设置库存、库存和概率要做适当匹配；库存为0 则过滤该藏品</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group consignment-paid-trainee"  style="display: <?= $model['is_open_consignment'] == 20 ? 'block' : 'none' ?>;">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">设置转增时间</label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="text" name="goods[consignment_minute]" placeholder="请输入寄售时间(分钟)" class="layui-input" value="{{$model.consignment_minute}}">
                                    </div>
                                </div>
                            </div>
                            <!-- 转增 -->
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" name="goods[sales_initial]" placeholder="请输入已售" class="layui-input" value="<?= $model['sales_initial'] ?>">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
