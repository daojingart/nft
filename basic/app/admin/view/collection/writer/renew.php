        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <input type="hidden" name="writer[id]" value="{{$model.id}}">
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text"  maxlength="8" class="tpl-form-input" name="writer[name]" value="{{$model.name}}" placeholder="请输入作家名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                    ...
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                {{if isset($model['headimg'])}}
                                                    <div class="file-item">
                                                        <img src="<?= $model['headimg'] ?>">
                                                        <input type="hidden" name="writer[headimg]" value="<?= $model['headimg'] ?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <textarea rows="5" name="writer[introduce]" placeholder="个人介绍">{{$model.introduce}}</textarea>
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">是否展示作品 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="writer[status]" value="0" title="启用" {{if $model.status == 0}} checked {{/if}}>
                                    <input type="radio" name="writer[status]" value="1" title="隐藏" {{if $model.status == 1}} checked {{/if}}>
                                </div>
                            </div>
