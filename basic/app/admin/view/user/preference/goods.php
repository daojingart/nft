        ...
        <div class="layui-row layui-col-space12">
            <form class="layui-form table_serch_input" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="product_types" id="">
                            <option value="">选择藏品类型</option>
                            <option value="1">抢购藏品</option>
                            <option value="2">空投仓库藏品</option>
                            {{if $types != 'exchange'}}
                            <option value="3">盲盒</option>
                            {{/if}}
                            <option value="4">申购</option>
                            <option value="5">盲盒内藏品</option>
                        </select>
                    </div>
...
<script>
    ...
    layui.use(['table', 'form', 'jquery','laydate'], function() {
        ...
        let tableIns = table.render({
            elem: '#goods-table',
            url: "{{:url('collection.goods/synthesis')}}",
            page: true,
            cols: cols,
            skin: 'line',
            limit:8,
