                ...
                <form id="my-form" class="am-form tpl-form-line-form"  lay-filter="create_table_from" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">持有数量</label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        <input id="hold_goods_number" style="border: 1px solid #ccc;" type="number" name="order[pay_time]"
                                               class="am-form-field" min="0"
                                               value="" required>
                                        <span class="am-input-group-label am-input-group-label__right">个</span>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">额外增加购买次数</label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group">
                                        <input id="purchase_quantity" style="border: 1px solid #ccc;" type="number" name="order[pay_time]"
                                               class="am-form-field" min="0"
                                               value="" required>
                                        <span class="am-input-group-label am-input-group-label__right">个</span>
                                    </div>
