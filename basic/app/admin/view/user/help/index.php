            ...
            <form class="layui-form table_serch_input" action="">
                <div class="layui-form-item">
                    <div class="layui-input-inline">
                        <input type="text" name="title" placeholder="请输入新闻标题" class="layui-input">
                    </div>
        ...
        <div class="layui-row">
            ...
            <div class="layui-card-body">
                <div class="layui-col-md3 bl-layui-left">
                    <a class="layui-btn layui-btn-normal" href="<?= url('user.help/add') ?>">
                        新增帮助
                    </a>
                </div>
            </div>
    ...
    layui.use(['table', 'form', 'jquery','dropdown'], function() {
        ...
        window.remove = function(obj) {
            layer.confirm('确认吗？', {
                ...
                layer.close(index);
                let loading = layer.load();
                $.getJSON("{{:url('common/del')}}", {'id' : obj.data['id'],"dbname":'News'}, function(result){
                    layer.close(loading);
                    if(1 === result.code){
                        layer.msg(result.msg, {
                            icon: 1,
