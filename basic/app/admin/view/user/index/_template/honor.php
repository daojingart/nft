                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">调整账户荣誉</div>
                            </div>
                            <input type="hidden" name="balance[type]" value="2" title="荣誉余额">

                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">选择操作</label>
                                <div class="am-u-sm-9 am-u-end layui-form">
                                    <input type="radio" name="balance[balance_type]" value="1" title="增加荣誉"  checked>
                                    <input type="radio" name="balance[balance_type]" value="2" title="减少荣誉">
                                </div>
                            </div>
                            <div class="am-form-group">
