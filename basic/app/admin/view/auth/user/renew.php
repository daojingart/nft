                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="user[role_id]"  data-am-selected="{ btnSize: 'sm'}" >
                                        ...
                                        <option value="{{$vo.id}}" {{if $model['role_id'] == $vo.id}} selected {{/if}}>{{$vo.role_name}}</option>
                                        {{/volist}}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="user[status]" value="1" title="启用" {{if $model.status == '1'}} checked {{/if}}>
                                    <input type="radio" name="user[status]" value="2" title="禁用" {{if $model.status == '2'}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
