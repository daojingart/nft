            ...
            <div class="widget am-cf">
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <input type="hidden" name="node[id]" value="{{$info.id}}">

                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑节点信息</div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-input-group">
                                    <input type="text" class="tpl-form-input" name="node[node_name]"
                                           value="{{$info.node_name}}" placeholder="请输入节点名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="node[p_id]"   data-am-selected="{ btnSize: 'sm'}">>
                                        ...
                                        <option value="{{$vo.id}}" {{if $info.p_id == $vo.id}} selected {{/if}}>{{$vo.node_name}}</option>
                                        {{/volist}}
                                    </select>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="node[controller_name]"
                                           value="{{$info.controller_name}}" placeholder="请输入控制器名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="node[action_name]"
                                           value="{{$info.action_name}}" placeholder="请输入方法名称" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="node[menu_icon]"
                                           value="{{$info.menu_icon}}" placeholder="请输入节点图标">
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">是否显示节点</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="node[disabled]" value="1" title="显示" {{if $info.disabled=='1'}} checked {{/if}}>
                                    <input type="radio" name="node[disabled]" value="0" title="隐藏" {{if $info.disabled=='0'}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="node[sort]"
                                           value="{{$info.sort}}" placeholder="请输入排序序号;正序排列;数字越小越在前">
