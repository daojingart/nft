    ...
    <div class="layui-card-body">
        <div class="layui-tab layui-tab-brief" lay-filter="edit_user_tab">
            <ul class="layui-tab-title store_system">
                ...
                <li  class="layui-this"><a href="{{:url('store.setting/service')}}">服务费配置</a></li>
                                        ...
                                        <div class="widget-body">
                                            <fieldset>
                                                ...
                                                <div class="widget-head am-cf">
                                                    <div class="widget-title am-fl">服务费配置</div>
                                                </div>
                                                <div class="am-form-group layui-form">
                                                    <label class="am-u-sm-2 am-form-label form-require">平台服务费比例</label>
                                                    <div class="am-u-sm-5">
                                                        <div class="am-input-group">
                                                            <input style="border: 1px solid #ccc;" type="number" name="service[service_fee]" class="am-form-field" min="0" value="{{$values.service_fee?=$values.service_fee}}" required>
                                                            <span class="am-input-group-label am-input-group-label__right">%</span>
                                                        </div>
                                                    </div>
                                                    <label class="am-u-sm-2 am-form-label"></label>
                                                    <div class="am-u-sm-10"><small>二级市场交易的时候,扣除平台服务费比例</small></div>
                                                </div>
                                                <div class="am-form-group layui-form">
                                                    <label class="am-u-sm-2 am-form-label form-require">创作者版权分成比例</label>
                                                    <div class="am-u-sm-5">
                                                        <div class="am-input-group">
                                                            <input style="border: 1px solid #ccc;" type="number" name="service[creator_fee]" class="am-form-field" min="0" value="{{$values.creator_fee?=$values.creator_fee}}" required>
                                                            <span class="am-input-group-label am-input-group-label__right">%</span>
                                                        </div>
                                                    </div>
                                                    <label class="am-u-sm-2 am-form-label"></label>
                                                    <div class="am-u-sm-10"><small>二级市场交易的时候,扣除创作者版权分成比例</small></div>
                                                </div>
