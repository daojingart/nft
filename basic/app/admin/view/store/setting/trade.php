                                ...
                                <div class="am-u-sm-9 layui-form">
                                    <div class="am-u-sm-12">
                                        <label class="am-radio ">
                                            <input type="radio" name="trade[freight_rule]" value="10" title="叠加" <?= $values['freight_rule'] === '10' ? 'checked' : '' ?> required>
                                        </label>
                                    ...
                                    <div class="am-u-sm-12 am-margin-top-sm">
                                        <label class="am-radio">
                                            <input type="radio" name="trade[freight_rule]" value="20" title="以最低运费结算" <?= $values['freight_rule'] === '20' ? 'checked' : '' ?> required>
                                        </label>
                                        <div class="help-block">
                                    ...
                                    <div class="am-u-sm-12 am-margin-top-sm">
                                        <label class="am-radio">
                                            <input type="radio" name="trade[freight_rule]" value="30" title="以最高运费结算" <?= $values['freight_rule'] === '30' ? 'checked' : '' ?> required>
                                        </label>
                                        <div class="help-block">
