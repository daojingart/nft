                        ...
                        <fieldset>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        ...
                                        <div class="help-block am-margin-top-sm">
                                            <small>尺寸88x88像素以上，大小2M以下</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="navigation[title]" value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require">跳转URL</label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="navigation[link_url]" value="" required>
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">是否显示</label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="navigation[disabled]" value="10" title="显示" checked>
                                    <input type="radio" name="navigation[disabled]" value="20" title="隐藏">
                                </div>
                            </div>
                            <div class="am-form-group">
