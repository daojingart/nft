                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group layui-form">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="banner[type]" value="1" title="数字藏品" {{if $model.type == 1}} checked {{/if}}>
                                    <input type="radio" name="banner[type]" value="2" title="实物商城" {{if $model.type == 2}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
