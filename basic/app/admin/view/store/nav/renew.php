                        ...
                        <fieldset>
                                        ...
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                {{if isset($model['icon'])}}
                                                    <div class="file-item">
                                                        <img src="<?= $model['icon'] ?>">
                                                        <input type="hidden" name="navigation[icon]" value="<?= $model['icon'] ?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                {{if isset($model['selected_icon'])}}
                                                <div class="file-item">
                                                    <img src="<?= $model['selected_icon'] ?>">
                                                    <input type="hidden" name="navigation[selected_icon]" value="<?= $model['selected_icon'] ?>">
                                                    <i class="iconfont icon-shanchu file-item-delete"></i>
                                                </div>
                                                {{/if}}
                                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="navigation[name]" value="<?= $model['name'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require">跳转URL</label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="navigation[url]" value="<?= $model['url'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group layui-form">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">是否显示 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="radio" name="navigation[status]" value="10" title="显示" {{if $model.status == 10}} checked {{/if}}>
                                    <input type="radio" name="navigation[status]" value="20" title="隐藏" {{if $model.status == 20}} checked {{/if}}>
                                </div>
                            </div>
                            <div class="am-form-group">
