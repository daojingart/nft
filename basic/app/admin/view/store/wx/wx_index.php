    ...
    <div class="layui-card-body">
        <div class="layui-tab layui-tab-brief" lay-filter="shopOrder">
            <ul class="layui-tab-title">
                <li class="layui-this" data-template="wx_system">公众号配置</li>
            </ul>
            <!--内容区域-->
...
{{include file="store/wx/_template/wxSystem"/}}
{{include file="store/wx/_template/templateSystem"/}}
{{include file="store/wx/_template/shareSystem"/}}
<script>
