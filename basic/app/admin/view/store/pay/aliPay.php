    ...
    <div class="layui-card-body">
        <div class="layui-tab layui-tab-brief" lay-filter="edit_user_tab">
            <ul class="layui-tab-title store_system">
                ...
                <li class="layui-this"><a href="{{:url('store.pay/alipay')}}" >支付宝支付</a></li>
                                    ...
                                    <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-u-sm-9 am-u-end layui-form">
                                                <input type="radio" name="aliPay[open_status]" value="10" title="开启" <?= $values['open_status'] === '10' ? 'checked' : '' ?>>
                                                <input type="radio" name="aliPay[open_status]" value="20" title="关闭" <?= $values['open_status'] === '20' ? 'checked' : '' ?>>
                                            </div>
                                        </div>
                                        <div class="widget-head am-cf">
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-u-sm-9">
                                                <input type="text" class="tpl-form-input" name="aliPay[app_id]"
                                                       value="{{$values.app_id ?? ''}}" required>
                                                <small>必填-支付宝分配的 app_id</small>
                                            </div>
                                        </div>
                                        <div class="am-form-group">
                                            <label class="am-u-sm-3 am-form-label form-require">
                                            ...
                                            <div class="am-u-sm-9">
                                                <textarea class="tpl-form-input" name="aliPay[app_private_key]"  cols="30" rows="5" required>{{$values.app_private_key ?? ''}}</textarea>
                                                <small>必填-应用私钥证书;</small>
                                            </div>
                                        </div>
                                        <div class="am-form-group">
                                            <label class="am-u-sm-3 am-form-label form-require">
                                            ...
                                            <div class="am-u-sm-9">
                                                <textarea class="tpl-form-input" name="aliPay[app_public_key]"  cols="30" rows="5" required>{{$values.app_public_key ?? ''}}</textarea>
                                                <small>必填-支付宝公钥证书</small>
                                            </div>
                                        </div>
                                        <div class="am-form-group">
